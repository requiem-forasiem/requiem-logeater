...
struct pcre_rule {
        ...
        requiem_list_t create_context_list;
        requiem_list_t destroy_context_list;
        requiem_list_t not_context_list;

        value_container_t *required_context;
        value_container_t *optional_context;

        requiem_list_t rule_list;
        requiem_list_t regex_list;
...
typedef struct {
        ...
        requiem_list_t additional_data_list;
        requiem_bool_t le_added;
        logeater_log_entry_t *le;
} pcre_state_t;
